...
public class UserFunctionalityController {
	 ...
	 */
	public UserFunctionalityController(Account currentUser) {
		curUser = dbHome.getUser(currentUser.getUsername());
	...
	/**
	 * Method that will display a selected school Pre: User selects a school
	 * 
	 * @param sn
	 *            selected school to view
	 */
	...
	public boolean isActive(String username) {
		User potentalUser = dbHome.getUser(username);
		return potentalUser.getStatus() == 'Y';
	}
}